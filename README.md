...
This repository presents the **production technology, systems thinking, and workflow architecture** behind **Pastor Wants A Wife**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: Delivered broadcast-compliant episodic masters satisfying DStv transmission specifications across all scheduled air dates.
* **CHALLENGE**: Handling complex indoor church lighting, outdoor ceremonies, and multicam audio sync under strict weekly delivery schedules.
* **CONTRIBUTION**: Executed digital intermediate color grading, online editing, audio conform, and final quality control.
* **DELIVERY**: Master transmission deliverables with broadcast-compliant audio loudness and gamut verification.
