# Pastor Wants A Wife — Production Engineering & Workflow Architecture
## DStv · Mzansi Magic · Channel 161 · Film & TV · Client: Connect TV

![Pastor Wants A Wife Banner](assets/PWA.webp)
...
In this repository, I present the **production technology, systems thinking, and workflow architecture** behind my work on **Pastor Wants A Wife**, broadcast across **DStv · Mzansi Magic · Channel 161**.
...
* **RESULT**: I delivered broadcast-compliant episodic masters satisfying DStv transmission specifications across all scheduled air dates.
* **CHALLENGE**: I handled complex indoor church lighting, outdoor ceremonies, and multicam audio sync under strict weekly delivery schedules.
* **CONTRIBUTION**: I executed digital intermediate colour grading, online editing, audio conform, and final quality control.
* **DELIVERY**: I prepared master transmission deliverables with broadcast-compliant audio loudness and gamut verification.
...
├── assets/
│   └── PWA.webp                 ← Production visual master
├── diagrams/
